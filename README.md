...
1. Load `index.html` (or visit the dev server URL). You should see the dark overlay with the **Start** button.
2. Press **Enter** or click **Start** – or wait two seconds for the auto-start – to spawn at the level entrance and show the HUD (mask, ammo, score, and combo timer).
